...
if uploaded_file is not None:
    ...
    if st.button("Perform t-SNE"):
        ...
        perplexity = min(30, num_samples // 3)  # Choose a smaller perplexity if the sample size is small
        ...
        # Plotting
        fig, ax = plt.subplots()
        scatter = ax.scatter(tsne_results[:, 0], tsne_results[:, 1], c=label_numbers, cmap='tab10', alpha=0.6)
